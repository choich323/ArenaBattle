...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UABCharacterStatComponent_Statics::NewProp_CurrentHP_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Stat" },
		{ "Comment", "// Transient?? ????\xc8\xadSerialization???? ?????\xcf\xb1? ???? ???\xc9\xbe?. ???? \xc3\xbc???? ???? ?????\xc7\xb9\xc7\xb7? ?????\xcd\xb8? ?????\xd8\xbc? ?????? ?\xca\xbf\xe4\xb0\xa1 ????.\n" },
		{ "ModuleRelativePath", "ABCharacterStatComponent.h" },
		{ "ToolTip", "Transient?? ????\xc8\xadSerialization???? ?????\xcf\xb1? ???? ???\xc9\xbe?. ???? \xc3\xbc???? ???? ?????\xc7\xb9\xc7\xb7? ?????\xcd\xb8? ?????\xd8\xbc? ?????? ?\xca\xbf\xe4\xb0\xa1 ????." },
	};
#endif
	...
	IMPLEMENT_CLASS(UABCharacterStatComponent, 2619592398);
